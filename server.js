...
// begin application after connection
...
// prompts that will be given to user
...
// function to prompt users to verify they know employee ID, then call updateRole fucntion
    ...
    inquirer.prompt([
        {
            name: "action",
            type: "list",
            message: "Do you know the employee ID?",
